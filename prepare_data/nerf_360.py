...
parser.add_argument('--random_views', type=bool,  default=False,
...
if args.format == 'OPEN_EXR':
  ...
  print("=============================depth {}".format(args.depth_scale))
  map.use_min = True
  map.min = [0]
...
for i in range(0, args.views):
    ...
    frame_data = {
        'file_path': "./{}/r_{}".format(args.split, i),
...
with open(fp + '/' + 'transforms_{}.json'.format(args.split), 'w') as out_file:
